...
class Vgg16():
    ...
    def finetune(self, batches):
        ...
        """
        self.ft(len(batches.class_indices.keys()))
    ...
    def fit(self, batches, val_batches, nb_epoch=1):
        """
            ...
            See Keras documentation: https://keras.io/models/model/
        """
        self.model.fit_generator(batches,                    steps_per_epoch=batches.samples//batches.batch_size,validation_data=val_batches,epochs=nb_epoch,    validation_steps=val_batches.samples//val_batches.batch_size)
